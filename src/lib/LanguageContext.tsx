...
const translations = {
  ...
  artistSubtitle: 'Guitarist, Composer & Producer',
  artistSubtitleEn: 'Guitarist, Composer & Producer',
  ...
  // Footer
  footerDesc: 'خالق طنین‌های ماندگار جاز، سول و آهنگسازی کاربردی در ایران',
  footerDescEn: 'Creator of everlasting jazz, soul melodies & applied composition in Iran',
  footerCopyright: '© تمام حقوق معنوی و هنری متعلق به استاد کیانور پرتوی می‌باشد.',
  footerCopyrightEn: '© All intellectual and artistic rights belong to Kianour Partovi.',
  footerSubCopyright: 'وب‌سایت رسمی و هنری کیانور پرتوی - توسعه‌یافته با ری‌اکت و تیلوند',
  ...
  adminPanelLink: 'پنل مدیریت استاد',
  ...
  aboutBioP2: 'به عنوان یک مهندس صدا معتقدم اصالت صدای آنالوگ - با تمام خش‌خش‌های شیرین و گرمای منحصربه‌فردش - جادویی دارد که هرگز در دنیای سرد دیجیتال شبیه‌سازی نخواهد شد. از این رو، در استودیوی شخصی‌ام همواره تلاش می‌کنم رنگ صوتی و بافت زنده و نوستالژیک را در کارنامه هنری‌ام حفظ کنم.',
  ...
  musicDesc: 'گلچینی از برترین تکنوازی‌ها، ترانه‌ها، بداهه‌نوازی‌های جاز و پروژه‌های تنظیمی کیانور پرتوی در سبک‌های جاز، سول و فانک.',
  musicDescEn: 'A curated selection of the finest solos, songs, jazz improvisations, and arranging projects by Kianour Partovi in jazz, soul, and funk.',
  cassetteTitle: 'پخش‌کننده نوار کاست آنالوگ (تعاملی)',
  cassetteTitleEn: 'Analog Cassette Tape Player (Interactive)',
  ...
  contactCardTitle: 'راه‌های ارتباطی مستقیم با استودیو نوستالژیا',
  contactCardTitleEn: 'Direct Contacts with Nostalgia Studio',
  ...
  officeAddress: 'تهران، خیابان شریعتی، بالاتر از پل سیدخندان، کوچه باغ نوستالژیا، پلاک ۱۲',
  officeAddressEn: 'No. 12, Nostalgia Lane, Shariati St, Tehran, Iran',
  ...
  workHoursValue: 'شنبه تا چهارشنبه - ساعت ۱۱ الی ۱۹ (با هماهنگی قبلی)',
  workHoursValueEn: 'Sat to Wed - 11:00 AM to 7:00 PM (With appointment)',
